 ...
 * control topic があればロスターから自分以外・失効させていないエンドポイントへ fan-out し、
...
suspend fun resolveSendTopics(
    ...
    return resolveDeliveryTopics(result, config.deviceId, config.deliveryTopics, config.revokedDeviceIds)
}
